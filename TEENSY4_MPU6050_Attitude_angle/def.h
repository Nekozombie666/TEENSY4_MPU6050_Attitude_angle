...
/* ESP32 (ESP32) **************************************************************/
  ...
  #define POWERPIN_ON                ;
  #define POWERPIN_OFF               ;
  #define I2C_PULLUPS_ENABLE         pinMode (21, INPUT_PULLUP);pinMode (22, INPUT_PULLUP);
  #define I2C_PULLUPS_DISABLE        pinMode (21, INPUT);       pinMode (22, INPUT);
  
  #define USEWIRELIB //Sensors.cpp で　wire.hを使用する
  #define LOOP_TIME 2200             // 1000us  T4 only 
  #define I2C_SPEED 400000L         // 1MHz T4 only
#endif
/**************************************************************************************/
/* IMUの向きとセンサーの定義 */
/**************************************************************************************/
